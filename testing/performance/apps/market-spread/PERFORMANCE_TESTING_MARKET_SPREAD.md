...
```bash
sudo cset proc -s user -e numactl -- -C 1,17 chrt -f 80 ~/wallaroo/utils/data_receiver/data_receiver --ponythreads=1 --ponynoblock --ponypinasio -w -l wallaroo-follower-2:5555
```
