...
sudo cset proc -s user -e numactl -- -C 14,17 chrt -f 80 ../../../../utils/data_receiver/data_receiver --ponythreads=1 --ponypinasio --ponynoblock -w -l 0.0.0.0:5555

2) metrics sink (if not using Monitoring Hub):
sudo cset proc -s user -e numactl -- -C 14,17 chrt -f 80 ../../../../utils/data_receiver/data_receiver --ponythreads=1 --ponypinasio --ponynoblock -w -l 0.0.0.0:5001
