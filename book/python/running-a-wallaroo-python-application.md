...
```bash
export PYTHONPATH="$PYTHONPATH:$HOME/wallaroo-tutorial/machida/lib:$HOME/wallaroo-tutorial/examples/python/celsius"
```
...
```bash
export PYTHONPATH="$PYTHONPATH:$HOME/wallaroo-tutorial/machida/lib:."
```
